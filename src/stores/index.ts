...
export const initializeStores = async () => {
  ...
  const { courses, learners, organizations, learnerProgress, certificates, auth } = useAppStore()
...
export const resetStores = () => {
  const { courses, learners, organizations, learnerProgress, certificates, auth, ui } = useAppStore()
